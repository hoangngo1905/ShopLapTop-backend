...
namespace ShopLapTop.Areas.Admin.Controllers
{
    ...
    public class OrderDetailController : Controller
    {
        ...
        public OrderDetailController(ShopLapTopContext context)
        {
            _context = context;
        }
        ...
        {
            var shopLapTopContext = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> Create([Bind("Id,Price,Quantity,Total,Status,ProductId,OrderId")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Price,Quantity,Total,Status,ProductId,OrderId")] OrderDetail orderDetail)
        {
